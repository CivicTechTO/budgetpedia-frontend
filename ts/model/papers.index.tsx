...
[draft proposal](https://drive.google.com/open?id=1kbCk5sA61eq_ttXgk8zLSwMxR5yMuujR) for a better budget design 
...
shape. Reserves, financial assets, tangible assets, net worth are all way up. In fact 
    ...
    children: [
        {
            ...
            properties: {
                markup:               
`## Current Unconventional Practices
`,
            }
        }
    ],
    ...
    children: [
        {
            ...
            properties: {
                markup:               
`## From _Budgets_ to _Variance Reports_ to _Audited Statements_
`,
            }
        }
    ],
    ...
    children: [
        {
            ...
            properties: {
                markup:               
`## Financial Planning Division's Vision
`,
            }
        }
    ],
...
`,
        ...
        },
        {
            ...
            properties:{
                markup:
`Note: _rate suported_ budgets include waste, water, and parking, because these programs are completely

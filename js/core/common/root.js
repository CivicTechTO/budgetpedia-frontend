...
const Root = ({ store, globalmessage, history }) => (React.createElement(MuiThemeProvider_1.default, { muiTheme: getMuiTheme_1.default() },
    React.createElement(react_redux_1.Provider, { store: store },
        React.createElement("div", null,
            ...
            globalmessage,
            React.createElement(routes_1.Routes, { history: history }),

...
const tilelist_view_1 = require("../../core/control/sub-components/tilelist.view");
const html_view_1 = require("../../core/control/sub-components/html.view");
const linklist_view_1 = require("../../core/control/sub-components/linklist.view");
const nuggetlist_view_1 = require("../../core/control/sub-components/nuggetlist.view");
const home_model_1 = require("./home.model");
const styles_index_1 = require("../../model/styles.index");
const master_model_1 = require("../../gateway/master.model");
let headerimages = master_model_1.default.getData('html', 'headerimages');
